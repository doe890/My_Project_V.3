<%-- 
    Document   : spark
    Created on : Nov 29, 2017, 4:25:51 PM
    Author     : Hacker
--%>
    ...
    <body>
        ...
        <jsp:include page="header.jsp"></jsp:include>
            <div class="mainContainer">
                <div class="shortlink">
                    <span><a href="index.jsp">Home</a></span> / <span><a href="#0"><%= productDao.getProduct(1).getProductName()%></a></span>
                </div>
            </div>
            <div class="spark-banner">
                <section class="bgbanner">
                    <h1><%= productDao.getProduct(1).getProductName()%></h1>
                </section>
            </div>
            <div class="showproduct">
                <h1>Spark</h1>
                <div class="showproduct_sizebar">
                    <a href="detail.jsp?productID=1" class="sparklink">
                        <div class="showproduct_img">
                            <img src="<%= productDao.getProduct(1).getProductImage() %>" alt="Spark Picture">
                        </div>
                        <div class="spark_info">
                            <h2><%= productDao.getProduct(1).getProductName()%></h2>
                            <p>Push your creative boundaries by fiying Spark with your hands or mobile device.</p>
                            <span class="price_spark">USD $<%= productDao.getProduct(1).getProductPrice()%></span>
                        </div>
                    </a>
                </div>
                <div class="showproduct_sizebar">
                    <a href="detail.jsp?productID=2" class="sparklink">
                        <div class="showproduct_img">
                            <img src="<%= productDao.getProduct(2).getProductImage() %>" alt="Spark Combo Picture">
                        </div>
                        <div class="spark_info">
                            <h2>Spark fly more combo</h2>
                            <p>Fly farther and faster with a remote controller, an extra battery, and accessories.</p>
                            <span class="price_spark">USD $<%= productDao.getProduct(2).getProductPrice()%></span>
